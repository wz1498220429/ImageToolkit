...
export const tools: Record<string, ToolMeta> = {
  ...
  "image-color-picker": {
    ...
    title: "Image Color Picker Online Free - Pick Colors from Image",
    description: "Free online color picker. Upload an image and click anywhere to get the exact hex, RGB, and HSL color values. Works in your browser, no uploads.",
    h1: "Image Color Picker Online Free",
    keywords: ["image color picker", "pick color from image", "color picker from image", "image color extractor", "get color from image"],
    category: "resize",
  },
  "add-watermark": {
    slug: "add-watermark",
    title: "Add Watermark to Image Online Free - Photo Watermark Tool",
    description: "Free online watermark tool. Add text watermarks to your images to protect your photos. Customize text, size, opacity, and position. No uploads needed.",
    h1: "Add Watermark to Image Online Free",
    keywords: ["add watermark to image", "image watermark", "watermark photo online", "add text to image", "photo watermark tool"],
    category: "resize",
  },
  "merge-images": {
    slug: "merge-images",
    title: "Merge Images Online Free - Combine Two Images Side by Side",
    description: "Free online image merger. Combine two images side by side, vertically, or as an overlay. Perfect for before/after comparisons. Browser-based, no uploads.",
    h1: "Merge Images Online Free",
    keywords: ["merge images", "combine images", "merge two images", "image merger", "join images side by side"],
    category: "resize",
  },
  "image-to-svg": {
    slug: "image-to-svg",
    title: "Convert Image to SVG Online Free - PNG to SVG Converter",
    description: "Free online image to SVG converter. Convert PNG, JPG images to SVG vector format. Perfect for logos and simple graphics. No uploads, browser-based.",
    h1: "Convert Image to SVG Online Free",
    keywords: ["image to svg", "convert image to svg", "png to svg", "jpg to svg", "raster to vector"],
    category: "convert",
  },
  "split-image": {
    slug: "split-image",
    title: "Split Image into Grid Online Free - Image Splitter Tool",
    description: "Free online image splitter. Split your image into a grid of equal parts. Perfect for creating Instagram puzzle posts, tiles, and collages. No uploads.",
    h1: "Split Image into Grid Online Free",
    keywords: ["split image", "image splitter", "split image into grid", "image grid splitter", "split photo into tiles"],
    category: "resize",
  },
  "pixelate-image": {
    slug: "pixelate-image",
    title: "Pixelate Image Online Free - Image Pixelizer Tool",
    description: "Free online image pixelator. Pixelate or censor parts of your images. Adjust pixel block size for the perfect pixel effect. Browser-based, no uploads.",
    h1: "Pixelate Image Online Free",
    keywords: ["pixelate image", "pixelate photo", "image pixelizer", "pixel art maker", "censor image online"],
    category: "resize",
  },
};
