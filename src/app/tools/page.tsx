...
const iconMap: Record<string, LucideIcon> = {
  ...
  "compress-image-to-10kb": ImageDown,
  ...
  "image-to-base64": RefreshCw,
  "base64-to-image": RefreshCw,
  "image-to-grayscale": FileImage,
  ...
  "blur-image": Shrink,
  "flip-image": RotateCw,
  "merge-images": ImageDown,
  "split-image": Crop,
  "pixelate-image": Shrink,
  "image-color-picker": RefreshCw,
  "add-watermark": Ruler,
...
const categories = [
  ...
  },
  {
    ...
    slugs: [
      "webp-to-png", "png-to-webp", "png-to-jpg", "jpg-to-png",
      "heic-to-jpg", "avif-to-jpg",
      "image-to-base64", "base64-to-image",
      "image-to-grayscale", "image-to-svg",
      "jpg-to-pdf", "png-to-pdf",
    ],
  },
  {
    name: "Image Editing",
    slugs: ["resize-image", "crop-image", "rotate-image", "blur-image", "flip-image",
      "merge-images", "split-image", "pixelate-image", "image-color-picker", "add-watermark"],
  },
  {
    name: "Photo Tools",
